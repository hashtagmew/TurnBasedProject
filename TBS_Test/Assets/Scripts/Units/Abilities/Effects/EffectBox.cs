...
public static class EffectBox {
	...
	static EffectBox() {
		...
		s_dEffectLookup.Add("Target Self", new Effect("Target Self", EFFECT_TYPE.ACTIVATION));
		...
		s_dEffectLookup.Add("(Race) Human", new Effect("Human", EFFECT_TYPE.PASSIVE));
		s_dEffectLookup.Add("(Race) Machine", new Effect("Machine", EFFECT_TYPE.PASSIVE));

		s_dEffectLookup.Add("(Unit Type) Infantry", new Effect("Infantry", EFFECT_TYPE.PASSIVE));
		s_dEffectLookup.Add("(Unit Type) Support", new Effect("Support", EFFECT_TYPE.PASSIVE));
	}
}